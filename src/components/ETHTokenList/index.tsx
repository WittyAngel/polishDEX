...
export default function TokenScanList() {
  ...
  const totalProfitLoss =
    totalValueOfAllTokens - startAssetsData?.totalValueOfAllTokens;

  const profitLossPercetage = totalProfitLoss
    ? (totalProfitLoss / totalValueOfAllTokens) * 100
    : 0;
  ...
  for (let i = 0; i < 5; ++i) {
    if (tokensAndPrices?.[i]) {
      ...
      values.push(tokensAndPrices[i]?.priceInUsd ?? 0);
      ...
      <div className={classes.wrapper}>
        <div className={classes.summary}>
          ...
          <div className={classes.chainWrapper}>
              ...
              <div className={classes.paper}>
                ...
                {isFetching ? (
                  ...
                  <div className={classes.totalVal}>
                    {formatUsd(totalValueOfAllTokens)}
                  </div>
                )}
              </div>
              <div className={classes.paper}>
            ...
            <div className={classes.totalValText}>GENERAL_PROFIT_LOSS</div>
            <div className={classes.valueWrapper}>
              {isFetching ? (
                <CircularProgress
                  color="secondary"
